...
sed -i "s/xsetroot/#xsetroot/g" /u01/app/oracle/product/11.2.0/xe/config/scripts/startdb.sh
sed -i "s/xsetroot/#xsetroot/g" /u01/app/oracle/product/11.2.0/xe/config/scripts/stopdb.sh
